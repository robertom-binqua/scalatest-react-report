...
export namespace SearchLauncherUtils {
    ...
    function calculateScreenshotCoordinates(testReports: TestReport[]): ScreenshotCoordinates[] {
    ...
    export function findScreenshotByTitleAndUrl(data: ScreenshotByTitleAndUrl[], titleAndUrl: String): ScreenshotByTitleAndUrl {
        return data.filter((value: ScreenshotByTitleAndUrl) => dataListVisibleString(value) === titleAndUrl)[0]
    }
