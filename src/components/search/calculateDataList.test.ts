...
test('SearchLauncherUtils.findScreenshotByTitleAndUrl returns the selected entry', () => {
    ...
    expect(SearchLauncherUtils.findScreenshotByTitleAndUrl(data, "title f_3 s_3 1 - url f_3 s_3 1")).toStrictEqual(
        {
            "id": 4,
            "screenshotCoordinates": [
                {
...
test('SearchLauncherUtils.findScreenshotByTitleAndUrl throws an Error if there is no entry', () => {
    ...
    expect(SearchLauncherUtils.findScreenshotByTitleAndUrl(data, "I do not exist")).toStrictEqual(
        {
            "id": 4,
            "screenshotCoordinates": [
                {
